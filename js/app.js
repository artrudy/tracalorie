...
class App {
    ...
    _newMeal(){
        ...
        const bsCollapse = new bootstrap.Collpse(collapseMeal, {
            toggle: true
        });
    }
    ...
    _newWorkout(){
        e.preventDefault();
        const name = document.getElementById('workou-name');
        ...
        const bsCollapse = new bootstrap.Collpse(collapseWorkout, {
            toggle: true
        });
    }
}
